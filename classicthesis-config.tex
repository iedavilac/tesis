...
\newcommand{\myTitle}{Aspectos de vórtices autoduales en el modelo Abeliano de Higgs\xspace}
...
%\usepackage{lmodern} % Changing font to Latin Modern
...
\areaset[current]{434pt}{761pt} % 686 (factor 2.2) + 33 head + 42 head \the\footskip
